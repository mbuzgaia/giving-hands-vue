<template>
  <main class="grid grid-flow-col grid-cols-11">
    <div
      class="bg-circle w-full col-span-11 aspect-square bg-slate-500 z-0 rounded-full fixed translate-auto bottom-10 sm:rounded-b-none"
    ></div>
    <div
      class="z-10 col-span-9 col-start-2 rounded-lg sm:col-span-9 sm:col-start-2 md:col-span-3 md:col-start-5 mt-12 bg-white border-2 border-slate-800"
    >
